...
# Plot Figure 1B: ancestry profiles of the screen-positive newborn cohort.
...
# Preserve the anonymous PRE-grouped order generated by the descriptive analysis.
panel <- ggplot(plot_data, aes(plot_index, proportion, fill = ancestry)) +
  ...
  labs(x = "Assigned PRE", y = "Ancestry proportion", fill = "Ancestry component") +
  theme_panel(9) +
  theme(
...
save_panel(panel, figure_dir, "Figure1B_cohort_ancestry", 12, 3.7)
